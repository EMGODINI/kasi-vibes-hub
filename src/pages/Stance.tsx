...
import { Camera, Heart, MessageCircle, Share, Filter, Plus, Car, Flame, X, MapPin, Calendar } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card className="bg-gray-800/50 border-gray-700">
              ...
              <CardContent className="space-y-3">
                {sponsoredAds.map((ad) => (
                  <div key={ad.id} className="bg-gradient-to-r from-orange-600/20 to-orange-400/20 p-3 rounded-lg border border-orange-500/30">
                    <h4 className="font-medium text-orange-400">{ad.business}</h4>
                    <p className="text-sm text-gray-300">{ad.contact}</p>
                    <p className="text-xs text-gray-400">{ad.location}</p>
                    <Badge variant="secondary" className="mt-2 bg-orange-600/20 text-orange-300">
                      Sponsored
                    </Badge>
                  </div>
                ))}
